...
<body>
    ...
    <div class="dropdown-content">
     ...
     <div class="div01" >
         <h3 style="margin-left:60px">Enter Your Complaint Details Below:</h3><hr>
                    <h4 style="margin-left:60px">University ID</h4>
                    <form method="post" action="complaint" id="compf">
                    <input type="text"  id="input1" name="univid" style="margin-left: 60px;font-size: 20px;" required onfocus="style.background='firebrick';style.color='white'" onblur="style.background='grey'">
                         <h4 style="margin-left:60px">Date of Filing</h4>
                    <input type="date" id="input2" name="dof" style="margin-left: 60px;font-size: 20px" required onfocus="style.background='firebrick';style.color='white'" onblur="style.background='grey'"><br>
                     
                    <h4 style="margin-left:60px">Complaint Description</h4>
                 
                               <textarea name="feed" style="margin-left: 60px" rows="5" cols="35"  form="compf"></textarea>
                               <br>
                               <br>
                   <input type="submit" value="File Complaint" style="background-color:red;color:white;text-decoration:none;font-size:20px;margin-left:15px;padding:16px 120px;border: 1px;border-radius:60px"></form>
                   
                   
                </div>
 <div class="div02" >
        <h3 style="margin-left: 80px;">Recent Filed Complaints:</h3>
        <hr>
<table border="2">
<tr>
<td>Sno.</td>
...
<% try {
                ...
                PreparedStatement st = con.prepareStatement("select * from compfile  join regsiter on compfile.univid = regsiter.pwd2 where regsiter.uname=?");
                st.setString(1,str1);
