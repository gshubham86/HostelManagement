...
<% try {
                ...
                PreparedStatement st = con.prepareStatement("select * from compfile");
                ...
                while (rs.next()) {
                    ...
                    <td><%= rs.getString(4)%></td>
                         ...
                         {%>       
                         <td><a href="updatecomp?id=<%=rs.getInt("id")%>&value=approved">Approve</a> / <a href="updatecomp?id=<%=rs.getInt("id")%>&value=rejected">Reject</a> </td>
