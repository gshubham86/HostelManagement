...
<div class="div01" >
         <h3 style="margin-left:60px">Add Notice Below:</h3><hr>
                    <h4 style="margin-left:60px">Notice Regarding</h4>
                    <form method="post" action="notice" id="notef">
                    <input type="text"  id="input1" name="regard" style="margin-left: 60px;font-size: 20px;" required onfocus="style.background='firebrick';style.color='white'" onblur="style.background='grey'">
                         
                    <h4 style="margin-left:60px">Notice Description</h4>
                               <textarea name="feed" style="margin-left: 60px" rows="5" cols="35"  form="notef"></textarea>
                    <br>
                    <br>
                    
                   <input type="submit" value="Add Notice" style="background-color:red;color:white;text-decoration:none;font-size:20px;margin-left:40px;padding:16px 100px;border: 1px;border-radius:60px"></form>
