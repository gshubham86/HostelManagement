...
String p2=request.getParameter("univid"); 
 ...
 String ls=request.getParameter("lstart"); 
 
 String le=request.getParameter("lend"); 
...
"insert into leaveapp (univid,ls,le,lt,reason) values(?,?,?,?,?)");  
...
if(i>0)  
{
    out.println("<script type=\"text/javascript\">");
       out.println("alert('Leave applied successfully');");
       out.println("</script>"); 
